...
import {
  ...
  localModel, piExecutable, piModel, repoBridgeUrl, geminiApiKey, geminiModel,
  ...
  orchestratorStateFile, workspacePath, memoryPath, skillsPath, hcpDir,
...
import {
  readLedger, addLedgerRun, updateLedgerRun, readJsonState, writeJsonState,
  saveOrchestratorState, orchestratorState, seoTaskLog, logSeoEvent,
} from './lib/state.mjs';
...
import { callRepoBridge, getRepoBridgeState, textFromLlamaResponse, callLocalModel, streamUpstream, extractJsonObject, callGpt4o, callClaude, callPiRpc } from './lib/models.mjs';
...
// Task event log — loaded from disk so it survives a server restart, max 100 entries
