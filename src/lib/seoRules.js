...
// Used by WeekPostsSection on the SEO Pipeline page to render red/green chips.
//
...
// Everything else (scheduled, pending, error handled elsewhere) is NEUTRAL — let
// the existing date/status colour logic on the page handle those rows.
...
// media_status values produced by mediaStatusFor() in SEO-Agents-App/action-enrich.mjs:
//   'video' | 'photo' | 'downgraded' | 'none'
// (NULL on GBP / pre-post rows.)
...
// Human-readable tooltip for a red row.
